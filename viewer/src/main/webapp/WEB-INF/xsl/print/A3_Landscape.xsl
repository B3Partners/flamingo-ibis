...
<xsl:stylesheet version="1.1"
    ...
    <xsl:variable name="map-width-px" select="'1050'"/>
    <xsl:variable name="map-height-px" select="784'"/>
        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <fo:page-sequence master-reference="a3-liggend">
                <fo:flow flow-name="body">
                    <fo:block-container width="40.9cm" height="0.9cm" top="0cm" left="0cm" background-color="#d2e9ef" xsl:use-attribute-sets="column-block-border">

                        <fo:block-container width="18.05cm" height="0.7cm" top="0.1cm" left="0.1cm" background-color="#d2e9ef" xsl:use-attribute-sets="column-block">
                            <xsl:call-template name="title-block"/>
                        </fo:block-container>

                        <fo:block-container width="18.05cm" height="0.7cm" top="0.1cm" left="18.15cm" background-color="#d2e9ef" xsl:use-attribute-sets="column-block">
                            <xsl:call-template name="subtitle-block"/>
                        </fo:block-container>

                        <fo:block-container width="4.5cm" height="0.7cm" top="0.1cm" left="36.3cm" background-color="#d2e9ef" xsl:use-attribute-sets="column-block">
                            <xsl:call-template name="logo-block"/>
                        </fo:block-container>

                    </fo:block-container>

                    <fo:block-container width="0.25cm" height="6.875cm" top="0.95cm" left="0cm" background-color="#003D5C" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag1-block"/>
                    </fo:block-container>

                    <fo:block-container width="0.25cm" height="6.975cm" top="7.775cm" left="0cm" background-color="#009900" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag2-block"/>
                    </fo:block-container>

                    <fo:block-container width="0.25cm" height="6.975cm" top="14.75cm" left="0cm" background-color="#FFED00" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag3-block"/>
                    </fo:block-container>

                    <fo:block-container width="0.25cm" height="6.975cm" top="21.725cm" left="0cm" background-color="#000000" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag4-block"/>
                    </fo:block-container>

                    <fo:block-container width="37.15cm" height="27.75cm" top="0.95cm" left="0.25cm" xsl:use-attribute-sets="column-block-border">
                        <xsl:call-template name="map-block"/>
                    </fo:block-container>

                    <fo:block-container width="4cm" height="4cm" top="24.7cm" left="33.4cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="schaal-block"/>
                    </fo:block-container>

                    <fo:block-container width="3.55cm" height="27.75cm" top="0.95cm" left="37.4cm" xsl:use-attribute-sets="column-block-border">

                        <fo:block-container width="3.55cm" height="2.5cm" top="0cm" left="0.1cm" xsl:use-attribute-sets="column-block">
                            <xsl:call-template name="overzicht-block"/>
                        </fo:block-container>

                        <fo:block-container width="3.55cm" height="23.9cm" top="2.5cm" left="0.1cm" xsl:use-attribute-sets="column-block">
                            <xsl:call-template name="legenda-block"/>
                        </fo:block-container>

                        <fo:block-container width="3.55cm" height="2.5cm" top="22.5cm" left="0.1cm" xsl:use-attribute-sets="column-block">
