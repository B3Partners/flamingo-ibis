...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="a4-liggend">
                <fo:flow flow-name="body">
					...
					<fo:block-container width="0.25cm" height="4.65cm" top="0.95cm" left="0cm" background-color="#003D5C" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag1-block"/>
                    </fo:block-container>
					
					<fo:block-container width="0.25cm" height="4.8cm" top="5.6cm" left="0cm" background-color="#009900" xsl:use-attribute-sets="column-block">
					...
					<fo:block-container width="0.25cm" height="4.8cm" top="15.2cm" left="0cm" background-color="#000000" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="vlag4-block"/>
                    </fo:block-container>
					
					<fo:block-container width="23.75cm" height="19.05cm" top="0.95cm" left="0.25cm" xsl:use-attribute-sets="column-block-border">
                        <xsl:call-template name="map-block"/>
                    </fo:block-container>
					
					<fo:block-container width="4cm" height="4cm" top="16cm" left="20.5cm" xsl:use-attribute-sets="column-block">
                        <xsl:call-template name="schaal-block"/>
                    </fo:block-container>
					
					<fo:block-container width="4.6cm" height="19.05cm" top="0.95cm" left="24cm" xsl:use-attribute-sets="column-block-border">
					
						<fo:block-container width="4.2cm" height="2.5cm" top="0cm" left="0.1cm" xsl:use-attribute-sets="column-block">
							<xsl:call-template name="overzicht-block"/>
						</fo:block-container>
	
						<fo:block-container width="4.2cm" height="14.2cm" top="2.5cm" left="0.1cm" xsl:use-attribute-sets="column-block">
							<xsl:call-template name="legenda-block"/>
						</fo:block-container>
						
						<fo:block-container width="4.2cm" height="2.5cm" top="16.7cm" left="0.1cm" xsl:use-attribute-sets="column-block">
	...
	<xsl:template name="overzicht-block">
        <fo:block margin-left="0.2cm" margin-top="0cm" color="#000000" xsl:use-attribute-sets="default-font">
