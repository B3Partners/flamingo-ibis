...
-- hernoemen van deze 4 bestaande zodat ze in de juiste edit tab terecht komen in flamingo
ALTER TABLE bedrijventerrein RENAME COLUMN o_minverkoop TO b_minverkoop;
ALTER TABLE bedrijventerrein RENAME COLUMN o_maxverkoop TO b_maxverkoop;
ALTER TABLE bedrijventerrein RENAME COLUMN o_minhuur    TO b_minhuur;
ALTER TABLE bedrijventerrein RENAME COLUMN o_maxhuur    TO b_maxhuur;
...
AS SELECT bedrijventerrein.ibis_id,
    ...
    bedrijventerrein.b_maxhuur,
    bedrijventerrein.b_maxverkoop,
    bedrijventerrein.o_milieuzone,
    bedrijventerrein.o_externebereikbaarheid,
    bedrijventerrein.b_minhuur,
    bedrijventerrein.b_minverkoop,
...
AS SELECT r.vvr_naam AS wgr_naam,
          ...
          t.b_minhuur AS huur_minimaal,
          t.b_maxhuur AS huur_maximaal,
          t.b_minverkoop AS verkoop_minimaal,
          t.b_maxverkoop AS verkoop_maximaal,
